...
# with open('our_test.json', 'w') as f:#
#     f.write(str(a))
...
class PublFromFile:
    def __init__(self, cnt_sent, filename, path='C:/Users/Nadiia_Podolets/PycharmProjects/podolets/HW8/'):
...
class PublFromJsonFile():
    def __init__(self, count_elements=0, filename='',
                 path='C:/Users/Nadiia_Podolets/PycharmProjects/podolets/HW8/'):
